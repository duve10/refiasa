                ...
                <div class='container-fluid p-0'>
                    <div class="row mb-2 mb-xl-3">
                        <div class="col-auto d-flex align-items-center">
                            <h1 class="h3 m-0"><strong>RT Atenciones</strong></h1>
                            <button class="btn btn-primary btnColorGeneral ms-2" id="updateRT">
                                <i id="btnUpdate" class="btnIcon align-middle fas fa-fw fa-sync-alt"></i>
                                <div id="iconUpdate" class="spinner-border spinner-border-sm text-white me-2 btnLoad d-none" role="status">
