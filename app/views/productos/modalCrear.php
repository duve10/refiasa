<div class="modal fade" id="crearProducto" tabindex="-1" style="display: none;" aria-hidden="true">
	<div class="modal-dialog modal-xl" role="document">
		<form id="formProducto">
			<div class="modal-content">
				<div class="modal-header">
					<h3 class="modal-title fw-bold">Crear Producto</h3>
				...
				<div class="modal-body m-3">
					...
					<div class="mb-3 row">
						...
						<label for="stock" class="col-md-2 col-xl-2 col-form-label fw-bold">Stock <span class="text-danger">*</span></label>
						<div class="col-md-4 col-xl-4">
